            ...
            <div class="col-md-6">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <?php if (!empty($discount)) {
                        ?>
                        <span class="badge text-bg-custom3">- <?php echo $discount ?> %</span>
                        <?php
                    } ?>
                </div>
                <hr>
                ...
                <div class="d-flex">
                    ...
                    if (!empty($discount)) {
                        ...
                        ?>
                        <h5 class="mx-1">
                            <span class="badge text-bg-custom4"><strike> <?php echo $prix ?> <i class="fa fa-solid fa-dollar"></i> </strike></span>
                        </h5>
                        <h5 class="mx-1">
                            <span class="badge text-bg-custom2"><?php echo $total ?> <i class="fa fa-solid fa-dollar"></i></span>
                        </h5>
