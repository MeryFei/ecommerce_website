...
<head>
    ...
    <title>Z🥀hra - Liste des produits</title>
</head>
<body>
<?php include 'include/nav_admin.php' ?>
<div class="container py-2">
    <h2>Liste des produits</h2>
    <a href="ajouter_produit.php" class="btn btn-add">Ajouter produit</a>
    <table class="table table-striped table-hover">
        ...
        foreach ($categories as $produit){
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-mod" href="modifier_produit.php?id=<?php echo $produit->id ?>">Modifier</a>
                    <a class="btn btn-delet" href="supprimer_produit.php?id=<?php echo $produit->id ?>" onclick="return confirm('Voulez vous vraiment supprimer le produit <?php echo $produit->libelle?> ?')">Supprimer</a>
                </td>
            </tr>
            <?php
        }
