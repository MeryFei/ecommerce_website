...
.custom-navbar {
    ...
    body {
    padding-top: 70px;
    background-image: url('images/grenii.jpg');    
...
<nav class="navbar navbar-expand-lg custom-navbar fixed-top ">
    <div class="container-fluid">
        <a class="navbar-brand" href="./front/">Z🥀hra</a> 
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                 ...
                 <?php
                    ...
                    <li class="nav-item">
                    <a class="nav-link <?php if ($currentPage == '/ecommerce/profil.php') echo 'active' ?>"
                       aria-current="page" href="profil.php"><i class="fa-solid fa-circle-user"></i> Profil</a>
                    </li>
                ...
                if ($connecte) {
                    ?>
                    <li class="nav-item">
                        <a class="nav-link <?php if ($currentPage == '/ecommerce/historique.php') echo 'active' ?>"
                           aria-current="page" href="historique.php"><i
                                    class="fa-solid fa-barcode"></i> Historique de Commandes</a>
                    </li>
                    ...
                    ?>
                    <li class="nav-item">
                        <a class="nav-link <?php if ($currentPage == '/ecommerce/connexion.php') echo 'active' ?>" href="connexion.php"><i class="fa-solid fa-arrow-right-to-bracket"></i> Connexion</a>
                    </li>
                    <?php
                }
                ?>
        ...
        <!--<a class="btn float-end" href="front/"><i class="fa-solid fa-cart-shopping"></i> Shop</a>-->
         <?php
                if ($connecte) {
         ?>
        <a class="btn float-end" href="front/"><i class="fa-solid fa-cart-shopping"></i> Shop </a>
