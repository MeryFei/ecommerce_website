    ...
    <div class="col-md-6 mb-4">
        <div class="card h-100">
            <?php if (!empty($produit->discount)): ?>
                <span class="badge rounded-pill text-bg-custom3 w-25 position-absolute m-2" style="right:0"> - <?= $produit->discount ?> <i
            ...
            <div class="card-footer bg-white" style="z-index: 10">
                <?php if (!empty($produit->discount)): ?>
                    <div class="h5"><span
                                class="badge rounded-pill text-bg-custom4"><strike> <?= $produit->prix ?></strike> <i
                                    class="fa fa-solid fa-dollar"></i></span></div>
                    <div class="h5"><span
                                class="badge rounded-pill text-bg-custom">Solde : <?= calculerRemise($produit->prix, $produit->discount) ?> <i
                                    class="fa fa-solid fa-dollar"></i></span></div>
                <?php else: ?>
                    <div class="h5"><span class="badge rounded-pill text-bg-custom2"><?= $produit->prix ?> <i
                                    class="fa fa-solid fa-dollar"></i></span></div>
                <?php endif; ?>
