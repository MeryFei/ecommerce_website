<div>
    ...
    <?php if ($idUtilisateur !== 0): ?>
        <form method="post" class="counter d-flex" action="ajouter_panier.php">
            <button onclick="return false;" class="btn btn-bleu-pastel    mx-2 counter-moins">-</button>
            ...
            <button onclick="return false;" class="btn btn-bleu-pastel mx-2 counter-plus mx-1">+</button>

            <button class="btn btn-add btn-sm" type="submit" name="ajouter">
                <?= $button ?>
            </button>
            <?php
            if ($qty != 0) {
                ?>
                <button formaction="supprimer_panier.php" class="btn btn-sm btn-delet mx-1 " type="submit"
                        name="supprimer">
